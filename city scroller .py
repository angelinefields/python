...
while not done:
    ...
    # --- Go ahead and update the screen with what we've draw0n.
    pygame.display.flip()
...
city_scroller_template.py
Open
Perrfection Peterkin 
(peterkinp123@gmail.com)Displaying city_scroller_template.py.